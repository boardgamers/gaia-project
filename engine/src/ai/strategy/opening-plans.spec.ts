...
import { Building, Command, Phase, Player } from "../../enums";
...
import { assessOpeningPlan, OPENING_PLAN_IDS, evaluateOpeningPlanTransition, rankOpeningPlans } from "./opening-plans";
