...
export default {
  ...
  [ResearchField.TradingBonus]: [
    ["trade >> 2k"], ["trade 1>> 2k,3c"], ["trade 1>> 2k,3c", "tech"], ["trade 1>> 2k,1o,3c", "3pw"], ["trade 1>> 2k,1o,3c,q", "tech"], ["trade 2>> 2k,1o,3c,q"]
  ],
  [ResearchField.TradingVolume]: [
    ["+ship"], ["+ship", "ship-range"], ["+2ship", "ship-move"], ["+2ship", "ship-range", "3pw"], ["+3ship", "ship-move", "1> up-nav,up-int"], ["+4ship", "ship-move", "ship-range"]
  ]
};
