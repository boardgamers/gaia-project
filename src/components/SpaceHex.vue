<template>
  <g :id="`${hex}`">
    ...
    <Building style="stroke-width: 10;" v-if="hex.data.building" :building='hex.data.building' :faction='faction(hex.data.player)' outline :flat="flat" :transform="`translate(0, -0.${flat ? 0 : 1}) scale(${flat ? 0.1 : 0.15})`" />
