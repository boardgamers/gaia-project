...
> Last updated: **2026-07-24** (iPhone-style chess drawer dots completed for master in viewer
> v5.37.8). The compact booster/federation pool and text-free chess face stay mounted in an exact-size
...
- **Sidebar chess:** implementation is complete in viewer v5.37.8. Any Gaia-game participant can
