...
164.  ✅ **The sticky bar floating mid-screen, taken off the "fix it again next time" list (2026-08-16,
      `claude/sticky-menu-float-mobile-y5icp7`, viewer v5.59.1).** Owner, with a screenshot of the
