<template>
  <div v-if="isLostFleet" class="lost-fleet-ships">
    <div class="lost-fleet-ships__viewport">
      <div class="lost-fleet-ships__face lost-fleet-ships__boards">
        <svg
          v-for="ship in ships"
          :key="ship"
...
.lost-fleet-ships__boards {
  ...
  // means it remains the sole height authority for the panel and the Pool/notes column beside it.
  display: flex;
