  ...
  <b-modal :id="id" size="lg" title="Rules and Factions" footer-class="rules">
    <div class="gaia-viewer-modal">
      ...
      <div v-else-if="rule === 'rules'">
        ...
        <ul>
          <li>
            Click on the network icon (right of power bowl) to leech network - how much power can be gained if other
            players upgrade buildings
          </li>
        ...
        <h5>2021-11-29</h5>
        <ul>
          <li>Highlight range when placing buildings</li>
        </ul>
        <h5>2021-11-28</h5>
        <ul>
          <li>
            Click on final tiles to see the the sectors or federations (for structures in federations, satellites) of a
            player
          </li>
        </ul>
        <h5>2021-11-27</h5>
