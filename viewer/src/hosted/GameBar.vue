 ...
 * own game list and GameNavPanel.vue's in-game menu (owner request: the two must be identical, and
 * a change to one must apply to both automatically). Purely presentational: navigation (`href`) is
 * computed internally since it's the same rule everywhere (open games preview, everything else
