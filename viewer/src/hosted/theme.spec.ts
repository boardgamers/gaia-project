...
describe("theme", () => {
  ...
  it("starts in dark mode without creating a stored preference", () => {
    initTheme();
  ...
  it("persists an explicit light choice and updates browser chrome colors", () => {
    applyTheme("light");
    ...
    expect(window.localStorage.getItem(STORAGE_KEY)).to.equal("light");
  });
